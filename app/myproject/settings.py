"""
Minimal Django settings for the final project.

This configuration reads secrets and database credentials from environment
variables so that they can be supplied at runtime via Docker or GitHub Actions.
"""
import os
...
# Database configuration: use environment variables provided at runtime
DATABASES = {
    'default': {
